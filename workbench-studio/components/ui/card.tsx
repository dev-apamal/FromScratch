...
export default function Card({ cardLink }: CardProps) {
  return (
    <>
      <Link href={cardLink} className="flex flex-col gap-3">
        <p
        ...
        >
          ...
          it was interesting — the design decisions, the offline-first
          architecture, the question of how little an app can do and still be
          worth using.
        </p>
        <p
          className="text-sm leading-relaxed"
